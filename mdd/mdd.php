...
<a href="/rkd/mooring/menu.php">Version 2.2</a>
includes the capability to predict the depth of towed bodies from
a moving ship with sheared currents, including the use of depressors and tow-floats. Version 2.2 (April 2009)
...
<br clear="left"> <hr> <h2>Installation</h2> <p align="justify">Version 2.2 (April 2009) of Mooring
...
shackle should be included). Once designed
...
nylon, Dacron, polypropylene, polyethylene and Kevlar.</p>
...
materials may be used (i.e. steel, aluminum, nylon, Dacron, polypropylene, polyethylene, and Kevlar),
...
<h1><a name="examples">5 Examples</a></h1> <p align="justify"> There are three primary mooring
...
can be compared against CDMS's SFMOOR.EXE (Surface Mooring) and SSMOOR.EXE (Sub-Surface Mooring).</p>
<hr>
...
<I>Last modified May 12, 2000.<br>
